...
import { FiUserPlus, FiTrash2, FiUsers, FiKey } from 'react-icons/fi';
import { departmentsService } from '../../services/departments.service';
import { usersService } from '../../services/users.service';
import AssignTicketAccessModal from './AssignTicketAccessModal';

interface DepartmentTicketAccessConfigProps {
  departmentId: string;
...
export default function DepartmentTicketAccessConfig({ 
  departmentId, 
  departmentName,
  isDefaultForRequesters,
  onUpdate
}: DepartmentTicketAccessConfigProps) {
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Controla quién puede crear tickets en {departmentName}
              </p>
            </div>
          </div>

          {/* Switch para acceso universal */}
          <div className="p-5 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border-2 border-blue-200 dark:border-blue-700 rounded-xl mb-6">
          ...
          {!isDefault && (
            <div>
              ...
              {loading ? (
                ...
                <div className="text-center py-12 text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700">
                  <FiUsers className="mx-auto text-5xl mb-3 opacity-50" />
                  <p className="font-medium text-lg mb-1">No hay usuarios con acceso específico</p>
                  <p className="text-sm">Otorga acceso a usuarios para que puedan crear tickets</p>
                </div>
              ) : (
